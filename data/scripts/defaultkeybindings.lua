...
IMPULSES:BindKey1( "GS_GAME", "KEY_1",		"IM_CAR_FIRE_2" )
IMPULSES:BindKey1( "GS_GAME", "KEY_SHIFT",		"IM_CAR_FIRE_2" )
IMPULSES:BindKey1( "GS_GAME", "KEY_2",			"IM_CAR_FIRE_3" )
IMPULSES:BindKey1( "GS_GAME", "KEY_CONTROL",			"IM_CAR_FIRE_3" )
IMPULSES:BindKey1( "GS_GAME", "KEY_3",			"IM_CAR_FIRE_4" )
IMPULSES:BindKey1( "GS_GAME", "KEY_ALT",			"IM_CAR_FIRE_4" )
